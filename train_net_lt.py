...
from adapteacher.modeling.meta_arch.resnet import build_resnet50_backbone
...
def setup(args):
    ...
    if(args.stage == 'align_or_pseudo'):
        pass
    elif(args.stage == 'train_dino'):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--stage", type=str, default="align_or_pseudo", help="training stage (train_dino, align_or_pseudo)")
