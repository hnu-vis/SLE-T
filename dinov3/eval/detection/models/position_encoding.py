...
def build_position_encoding(args):
    ...
    if args.position_embedding == PositionEncoding.SINE:  
        
        position_embedding = PositionEmbeddingSine(N_steps, normalize=True)
    elif args.position_embedding == PositionEncoding.LEARNED:  
        position_embedding = PositionEmbeddingLearned(N_steps)
    elif args.position_embedding == PositionEncoding.SINE_UNNORM:  
